...
import { 
  ...
  Calendar, Activity, Flame, Edit3, Camera, ArrowLeft, Save, Users, Trophy, Zap, TrendingUp, ChevronRight, Upload
} from "lucide-react";
                ...
                <div className="absolute -bottom-2 -right-2 flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="bg-indigo-600 p-2.5 rounded-full border-4 border-[#030303] shadow-xl text-white hover:scale-110 transition-all group/btn relative"
                      title="Upload Photo"
                    >
                    ...
                    <button
                      ...
                      className="bg-purple-600 p-2.5 rounded-full border-4 border-[#030303] shadow-xl text-white hover:scale-110 transition-all"
                      title="Build Avatar"
                    >
                    ...
                    {(profile.avatar_url || profile.avatar_config) && (
                      <button
                        ...
                        className="bg-red-600 p-2.5 rounded-full border-4 border-[#030303] shadow-xl text-white hover:scale-110 transition-all"
                        title="Remove Photo"
                      >

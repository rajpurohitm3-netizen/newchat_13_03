...
const parser_1 = require(require.resolve("@babel/parser", { paths: [process.cwd()] }));
const magic_string_1 = require(require.resolve("magic-string", { paths: [process.cwd()] }));
const estree_walker_1 = require(require.resolve("estree-walker", { paths: [process.cwd()] }));
